...
var style_verticesperimetro2025_25 = function(feature, resolution){
    var context = {
        feature: feature,
        variables: {}
    };
    ...
    var offsetY = 0;
    var placement = 'point';
    if (feature.get("nome_ok") !== null && resolution > 0 && resolution < 7) {
        labelText = String(feature.get("nome_ok"));
    }
